...
const createPassSchema = z.object({
    password: z.string()
    .min(3, 'o password é obrigatório conter  no minino 3 caracteres')
...
type CreatePassFormData = z.infer<typeof createPassSchema>;

export function FormPassData() {
    const {user} = useAuth();

    const { mutateAsync: createProfile } = UseProfile();
    const form = useForm<CreatePassFormData>({
    ...
    async function handleCreateForm(data: CreatePassFormData) {
